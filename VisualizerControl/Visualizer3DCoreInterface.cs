...
namespace VisualizerControl
{
    public class Visualizer3DCoreInterface : HwndHost
    {
        ...
        private Dictionary<string, int> shapeCodes = new();
        private Dictionary<string, int> materialCodes = new();
        private Dictionary<int, int> externalIndexToInternalIndex = new();
        ...
        [DllImport(dllName, EntryPoint = "ChangeMaterialColor", CallingConvention = CallingConvention.Cdecl)]
        private static extern void ChangeMaterialColorX(int index, float colorR,
